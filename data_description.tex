...
%		Numero istanze & 1000 \\
%		Numero attributi & 21 \\
%		Attributo target & \textbf{class} \\
%		Valori target & \texttt{\{good, bad\}} \\
%		\hline
%	\end{tabular}
%\end{table}
...
%		Numero attributi & 20 \\
%		Attributo target & \textbf{class}\\
%		Valori target & \parbox{3.5cm}{\texttt{\{brickface, sky, foliage, cement, window, path, grass\}}}\\
%		\hline
%	\end{tabular}
%\end{table}
...
%		Numero attributi & 19 \\
%		Attributo target &  \textbf{Class}\\
%		Valori target & \texttt{\{opel, saab, bus, ban\}} \\
%		\hline
%	\end{tabular}
%\end{table}
...
%		Numero attributi & 10 \\
%		Attributo target &  \textbf{Class} \\
%		Valori target & \texttt{\{benign, malignant\}} \\
%		\hline
%	\end{tabular}
%\end{table}
